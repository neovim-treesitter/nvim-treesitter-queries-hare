# nvim-treesitter-queries-hare

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-hare/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-hare/actions/workflows/validate.yml)

Neovim tree-sitter queries for **hare**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-hare",
...
- [ ] Changes are scoped to `hare` — do not include files for other languages
